...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference("Calendar.count") do
      post calendars_url, params: { calendar: { data: @calendar.data, public_id: @calendar.public_id, url: @calendar.url, user_id: @calendar.user_id } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { data: @calendar.data, public_id: @calendar.public_id, url: @calendar.url, user_id: @calendar.user_id } }
